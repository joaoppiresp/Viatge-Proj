...
<head>
    ...
    <meta name="description" content="Viatge page 400">
    <meta name="keywords" content="error 400">
            ...
            <div class="page-content error-page error2 text-white">
                <div class="container text-center">
                    <div class="error-template">
                        <h1 class="display-1 mb-2">4<span class="text-center custom-emoji"><svg xmlns="" height="140" width="140" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
